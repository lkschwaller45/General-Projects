...
Purpose: This code scrapes job websites to find job postings based on job titles and locations.
'''

#The two most important libaries are arguably beautiful soup and pandas. This data would be incoherent without pandas,
# and beautiful soup is used to parse the html of the website for the phrases being searched for.
import requests
import bs4
...
class Scraping:
    ...
    def __init__(self):
        ...
        results_per_city = 10
        cities = ["New+York", "Chicago%2CIL", "San+Francisco", "Austin", "Seattle", "Los+Angeles", "Philadelphia", "Atlanta",
